<template>
  <div>
    ...
    <!-- 结算明细弹窗 -->
    <el-dialog
      :visible.sync="settlementDetailData.dialogVisible"
      width="1000px"
    >
      <div slot="title">
        <i class="el-icon-document"></i>
        {{ settlementDetailData.dialogName }}
      </div>
      <el-table
        :data="settlementDetaiTableData"
        border
        :header-cell-style="{
          background: '#F5F5F5',
          color: '#94969A'
      ...
      >
        <el-table-column align="center" prop="collection" label="收款方">
        </el-table-column>
        <el-table-column
          align="center"
        ...
        <el-table-column align="center" prop="payment" label="付款公司">
        </el-table-column>
        <el-table-column
          align="center"
          prop="date"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          size="mini"
          type="primary"
          @click="closesettlementDetailDialog"
          >关闭
        </el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      settlementDetaiTableData: [
        {
          id: 66,
          date: '2016-05-03 08:08:08',
          collection: '收款方',
          collectionAmount: 123456,
          paymentMethod: '支付方式',
          payment: '付款方',
  ...
  methods: {
    ...
    closesettlementDetailDialog() {
      this.settlementDetailData.dialogVisible = false
    }
  }
}
</script>
